...
public class ConsultarCuentasNoConviven_qry_cuentasNoConviven_Rel extends
		MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			String qry = "SELECT MAT.FTN_NUM_CTA_INVDUAL, " +
						 ...
						 " WHERE MAT.FTC_FOLIO         = ? " +
						 " AND MAT.FTC_FOLIO_REL       = ? " +
						 " AND MAT.FTC_FOLIO_REL       = CLI.FTC_FOLIO " +
			...
			pstmt.setString(2, (String) inRoot.evaluateXPath("string(/consultarCuentasNoConviven/folioRel)"));
